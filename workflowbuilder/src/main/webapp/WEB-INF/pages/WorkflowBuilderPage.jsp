...
<script type="text/javascript"
	src="./resources/static/jquery-1.10.2.min.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="./resources/customJS/configuration.js"></script>
<script type="text/javascript"
...
<link rel="stylesheet" type="text/css"
	href="./resources/css/workFlowBuilder.css">
</head>
<body>
	<div class="wrapper" ng-controller="angularModalCtrl">
		...
		<div class="outer">
			<button class="btn btn-primary configure"
				style="float: right; background: orange; border: 2px solid black;"
				id="configurationId">Configure</button>
			<header>
				<div id="header-content">
					<h1>
						<img src="./resources/images/kuali-logo.png"
							alt="Image cannot be loaded" style="float: left"></img>
					</h1>
				</div>
			</header>
			<div class="container">
						...
						<div id="collapseOne" class="panel-collapse collapse in">
							<div id="row" class="panel-body">
								...
								<button class="helpButton "
									style="float: right; display: inline" id="startHelpId"
									popover={{nodesConfig.circle.helpText}} popover-trigger="focus">
								...
								<button class="helpButton " style="float: right"
									id="emailHelpId"
									popover={{nodesConfig.square.helpText}}
								...
								<button class="helpButton " style="float: right"
									id="requestHelpId"
									popover={{nodesConfig.rectangle.helpText}}
									popover-trigger="focus">
									<i class=" glyphicon glyphicon-question-sign pull-left"
										style="font-size: 20px"> </i>
								</button>
								...
								<button class="helpButton " style="float: right"
									id="simpleHelpId"
									popover={{nodesConfig.oval.helpText}}
								...
								<button class="helpButton " style="float: right"
									id="roletHelpId"
									popover={{nodesConfig.rectangleCoral.helpText}}
								...
								<button class="helpButton " style="float: right" id="noOpHelpId"
									popover={{nodesConfig.ovalMagenta.helpText}}
									popover-trigger="focus">
									<i class=" glyphicon glyphicon-question-sign pull-left"
										style="font-size: 20px"> </i>
								</button>
